...
class GameWindow(pyglet.window.Window):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        Lobby.lobbyInputHandler.on_mouse_press(x,y,button,modifiers)

    def on_key_press(self, symbol, modifiers):
        Lobby.lobbyInputHandler.textinputer.on_key_press(symbol, modifiers)

    def on_mouse_motion(self, x, y, dx, dy):
        Lobby.lobbyInputHandler.textinputer.on_mouse_motion(x, y, dx, dy, self)
...
Lobby = C_lobby.C_Lobby(keys, window, 12349)
